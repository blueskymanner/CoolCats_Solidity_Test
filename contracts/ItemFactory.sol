...
contract ItemFactory is ERC1155SupplyCC, AccessControl {
    ...
    /// @dev event of claim
    event LogDailyClaim(address _claimer, uint256 _rewardType, uint256 _rewardRarity, bytes _rewardData);
    ...
    function claim(address claimer, uint256 entropy, uint256 petTokenId) external {
        require(block.timestamp - _lastUpdate[petTokenId] > 86400, "You can only claim once per day");
